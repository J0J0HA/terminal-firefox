...
document.querySelectorAll("a").forEach((element) => {
    console.log(element.href, Boolean(match.exec(element.href)), match.exec(element.href))
...
if (typeof gterminal != "undefined") {
    ...
    if (gterminal.api_version != "1.3") {
        window.top.postMessage({
            set_title: "Version Mismatch"
        }, "*");
        window.location.href = "https://gterminal.is-a.dev/.github/notice/extension/VERSION_MISMATCH";
    }
} else {
